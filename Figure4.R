...
Idents(Stromal, cells = WhichCells(Stromal, idents = c("MYOC+ Fibroblast"))) <- 15
Idents(Stromal, cells = WhichCells(Stromal, idents = c("PCOLCE+ Fibroblast"))) <- 16
Idents(Stromal, cells = WhichCells(Stromal, idents = c("ISG+ Preadipocyte"))) <- 17
Idents(Stromal, cells = WhichCells(Stromal, idents = c("Metallothionein+ Preadipocyte/ASC"))) <- 18
...
"PTGDS+ Preadipocyte (9)", "CD9hi Preadipocyte (10)", "PTGDS+ ECM-Producing Preadipocyte (11)", "ECM-Producing Preadipocyte (12)", "Mature Preadipocyte 1 (13)", "Mature Preadipocyte 2 (14)", "MYOC+ Fibroblast (15)", 
"PCOLCE+ Fibroblast (16)", "ISG+ Preadipocyte (17)", "Metallothionein+ Preadipocyte/ASC (18)", "Myofibroblast (19)", "Lipomyofibroblast (20)", "DKK3+ Fibroblast (21)", "Proliferating Myofibroblast (22)"))
...
cor.test(Prop$LAM, Prop$Myofibroblast, method = "spearman") # rho = 0.72, p-value = 2.1e-15
...
cor.test(HIVneg$LAM, HIVneg$Myofibroblast, method = "spearman") # rho = 0.74, p-value = 9.6e-06
