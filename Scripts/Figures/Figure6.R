...
###-------------------####
# Figure 6D: CD4 Volcano Plot
###-------------------####
CD4_volcano <- VOLCANO(resOrderedDF = file_list$CD4.HIVpreDM.HIVnonDM, filename = paste(fig_dir, "Figure6D.png", sep = "/"), genes = c("BATF", "CTSD", "S100A6", "PFN1", "TCF7", "CD63", "IL7R",
"IFITM3", "SELL", "LEF1", "ACTB", "MT2A", "IL32", "CSTB", "SH3BGRL3", "TCF7"), ylim = c(0,3.5), xlim = c(-1.5,1.5))

###-------------------####
# Figure 6E: CD4 GSEA
###-------------------####
CD4_gsea_plot <- GSEA_plot(df = pathways_GO$CD4.HIVpreDM.HIVnonDM, filename = paste(fig_dir, "Figure6E.png", sep = "/"), num_path = 7)
