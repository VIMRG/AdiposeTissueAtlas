...
RNAclust_Markers <- function(seurat_object, outpath, ident.1) {
    ...
    assay = "RNA", min.pct = 0.25, only.pos = T) # Perform DGE
...
Integrated.markers <- RNAclust_Markers(Integrated, ident.1 = cluster, outpath = "/data/p_koethe_lab/Atlas_AT/HATIM_Analysis/6.27/DGE/")
